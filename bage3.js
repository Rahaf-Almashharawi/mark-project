...
function myFunction() {
    ...
    if (isNaN(mynumber) || +mynumber <= 0) {
        alert("Invalid input for the number of entries. Please enter a valid positive number.");
        return;
    }
    ...
    document.getElementById('demo4').innerHTML = "My Number is: " + mynumber + "My Name is: " + name +
        " Average Grade: " + grade +
